...
const movieDetail = async ({params}) => {
    ...
    return (
    <div className='bg-red-950 w-fit'>
            ...
            <div className="bg-transparent dark:bg-red-950 pt-8 w-full">
                <div className="w-full px-12">
                    <div className="flex flex-col md:flex-row h-[570px] w-full">
                        <div className="md:flex w-[63%] py-5 pb-9">
                            {/* image */}
                        ...
                        <div className="md:flex-1 pl-7 h-fit w-[37%] py-2 bg-red-950">
                            ...
                            <p className="text-white pt-14 dark:text-gray-300 text-sm">
                                {formattedDate}
                            </p>
                        </div>
                    </div>
